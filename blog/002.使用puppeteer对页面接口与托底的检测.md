 ...
 * @LastEditTime: 2020-09-05 12:21:08
 * @FilePath: /blog/blog/002.使用puppeteer对页面接口与托底的检测.md
-->

# 使用puppeteer对页面接口与托底的检测

![puppeteer](https://github.com/dtdths/blog/blob/master/static/blog-images/002.puppeteer.jpg)
